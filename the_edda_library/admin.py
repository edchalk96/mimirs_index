...
class LoreAdmin(SummernoteModelAdmin):
    ...
    list_display = ('title', 'status', 'author__username',
                    'is_deletion_pending', 'excerpt',)
    ...
    def approve_deletion(self, request, queryset):
        ...
        self.message_user(request,
                          f"Successfully removed {count} entries from the library")
    ...
    def publish_lore_entry(self, request, queryset):
        ...
        self.message_user(request,
                          f"Successfully published {count} entries to the library")
...
class CommentAdmin(SummernoteModelAdmin):
    ...
    def approve_comment(self, request, queryset):
        ...
        self.message_user(request,
                          f"Successfully approved and published {count} comments to relevent lore entries")
